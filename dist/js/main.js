...
$(document).ready(function() {
  ...
  (function() {
    ...
    $('[data-form-type-valide="1"').each(function() {
      $(this).validate({
        ...
        messages: {
          ...
          description: "Введите описание груза",
          address: "Введите адрес доставки",
          port: "Введите порт отгрузки"
        },
        errorElement: "div",
    ...
    $('[data-form-type-valide="2"').each(function() {
      $(this).validate({
        errorClass: "input-form-error",
        rules: {
          name: {
  ...
  (function() {
    ...
    $('[data-form-type="2"]').each(function(index, form) {
      $(this).on("submit", function(event) {
        event.preventDefault();
        if (!$(this).valid()) return;
   ...
   */
  (function() {
    var mySwiper = new Swiper("#slider-reviews", {
      slidesPerView: 1,
      effect: "fade",
      autoHeight: true,
